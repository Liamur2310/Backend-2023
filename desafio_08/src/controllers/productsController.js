...
class ProductController {
    ...
    async addProduct(req, res) {
        try {
            const { title, description, /* otras propiedades */ } = req.body;

            // Validaciones (puedes agregar validaciones adicionales según tus necesidades)

            const result = await this.productManager.addProduct(title, description, /* otras propiedades */);
